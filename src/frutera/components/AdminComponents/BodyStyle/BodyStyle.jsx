         ...
         <div className="BScontainer">
            ...
            <div className="leftPart">
               <ul>
                  ...
                  <li className='liBtn none' onClick={(e) => {changePosition(2);setPage("Users")}}><i className="fa-solid fa-users"></i><p>{t("registered")} {t("users")}</p></li>
                  <li className='liBtn none' onClick={(e) => {changePosition(3);setPage("Blogs")}}><i className="fa-solid fa-cart-shopping"></i><p>{t("orders")}</p></li>
                  <li className='liBtn none' onClick={(e) => {changePosition(4);setPage("Vouchers")}}><i className="fa-solid fa-star"></i><p>{t("vouchers")}</p></li>
                  <li className='liBtn none' onClick={(e) => {changePosition(5);setPage("Blogs")}}><i className="fa-solid fa-star"></i><p>{t("blogs")}</p></li>
               </ul>
            </div>
         </div>
      </>
