...
export const getPage = async () => {
  return {
    ...
    paragraphs:[
      ...
      {
        title:"სასარგებლო თვისებები",
        image:blog1,
        text:"შავ ქლიავში ვიტამინების, მიკროელემენტებისა და ბოჭკოს შემცველობა გაცილებით მაღალია ვიდრე ახალ ქლიავში,\n" +
            ...
            "                    დაივიწყოთ და დაკარგოთ ჭარბი წონის დიდი ნაწილი.",
      },
      {
        title:"სასარგებლო თვისებები",
